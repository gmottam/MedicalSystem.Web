...
export class EditarPacienteComponent implements OnInit {
  ...
  loadPaciente() {
    this.http.get<Paciente>(`${environment.apiBaseUrl}/paciente/${this.pacienteId}`).subscribe(paciente => {
  ...
  onSubmit() {
    ...
    const pacienteAtualizado = this.cadastroForm.value;
    pacienteAtualizado.id = this.pacienteId;

    this.http.put(`${environment.apiBaseUrl}/paciente/${this.pacienteId}`, pacienteAtualizado)
      .subscribe({
        next: (response) => {
